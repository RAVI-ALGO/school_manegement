...
if(isset($_POST['searchbtn']))
{
    ...
    //echo$stuclass;
    $selectQuery=mysqli_query($connection,"SELECT * FROM  student_fees WHERE schollar_no='$schNo'");
...
<head>
    ...
    <title>Student fees record by schollar no</title>
</head>
<body>
    ...
    if (isset($_POST['searchbtn']))
     {
         ...
         {
        if($selectQuery) {
          echo "<div class='alert alert-success alert-dismissible pb-1 fade show' role='alert'>
  <strong>✅😃😃😃</strong>".$Row_count." &nbsp;Record Found.
  <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
        } else {
          echo "<div class='alert alert-warning alert-dismissible pb-1 fade show' role='alert'>
    ...
    <div class="container-fluid">
        <form method="POST" id="search_form" enctype="multipart/form-data" class=" col-10 justify-content-center d-flex ">
        <div class="row mt-2 pb-2 mx-2">
    ...
    <h3 class="text-center  bg-info">Student Fees Record By Schollar  No.</h3>

    <?php 
    if(!empty($Row_count))
    {
        ?>
<div class="container-fluid" style="height:400px; width:100%; overflow: scroll;">	
<table  class="table table-hover mx-0 mt-2 " style="background-color: #dcdcdc	;" border="1px" cellpadding="10" cellspacing="0">
        <thead class="">
            <th>Schollar no.</th>
            <th>Name</th>
            <th>Father's name</th>
