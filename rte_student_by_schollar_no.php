...
<body>
        ...
        <div class="container-fluid menu">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="rte_student.php">RTE</a>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <h4 class="fs-4 bg-info text-center">RTE student Record BY Schollar NO.</h4>
        ...
        ?>
            ...
            foreach ($selectQuery as $dob) {
                ...
                if ($stuAge >= 6 && $stuAge <= 14) {
                    ...
                    $Row_Count = mysqli_num_rows($viewQuery);
            ?>
                    ...
                    <table class="table table-hover" style="background-color: #dcdcdc; border:solid black 2px;">
                        ...
                        ?>
                            ...
                            <script>
                                alert("Given schollar no is not Under RTE record.");
                            </script>
                    <?php
                    }
                }
