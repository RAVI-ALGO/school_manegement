...
if(isset($_POST['searchbtn']))
{
    ...
    //echo$stuclass;
    $selectQuery=mysqli_query($connection,"SELECT * FROM  student_fees WHERE class='$stuclass'");
...
<head>
    ...
    <title>Student fees record by class</title>
</head>
<body>
  ...
  <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
        ...
        <form method="POST" id="search_form" enctype="multipart/form-data" class=" col-10 justify-content-center d-flex mt-2">
            <div class="row mt-1 mx-2 pb-1">
                ...
                <div class="form-floating d-inline ">
                    ...
                    ?>
                    <select class="text-center fs-5 mt-1" id="classStu" name="classStu" aria-label="class select">
    ...
    <h3 class="text-center  pb-1 bg-info">Student Fees Record By Class</h3>
    <?php 
    if(!empty($Row_count))
    {
        ?>
